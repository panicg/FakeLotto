...
//        }
    ...
    public static float px2dp(float pixel) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                pixel,
                CommonApplication.Companion.getAppContext().getResources().getDisplayMetrics());
    }

    public static float dp2px(float dp) {
        int px = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, CommonApplication.Companion.getAppContext().getResources().getDisplayMetrics());
        return px;
    }
